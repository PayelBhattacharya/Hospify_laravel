            ...
            <div class="row">
                ...
                ">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <div class="row"> <img src="{{ 'admin/images/logo2.png' }}"
                                        class="logo" style="height: 48px;
                            margin-left: -79px;
                            margin-top: 28px;"> </div>
                                <h3>Log In</h3>
                      ...
                      font-size: 20px">Welcome to Hospify</p>
                            ...
                            <form method="post" action="{{ route('login') }}" name="login">
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Enter username">
                                    <input class="input100" type="email" name="email"
                                        placeholder="Enter Registered Email" style="    margin-bottom: 31px;
                            width: 23rem;
                            height: 3rem;
                            font-size: 1.2rem;
                            border-radius: 16px;
                            ...
                            box-shadow: 6px 6px 10px #678a7b;
                             color: white;">
                                ...
                                <p style="color: blue
                        ; margin-top: 1rem;">Not registered yet? <a href="{{ route('register') }}" style="color:blue;"
                                        onMouseOver="this.style.textDecoration='underline'">Register Here</a></p>
