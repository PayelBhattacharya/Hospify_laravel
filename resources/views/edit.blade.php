        ...
        <div class="bg-color">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form method="post"
                        action="{{ action('App\Http\Controllers\HospitalRegistrationController@update', $id) }}">
                        {{ csrf_field() }}
                                        ...
                                        <div class="card card-registration card-registration-2"
                                            ...
                                            <div class="card-body p-0">
                                                <div class="row g-0">
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <h3 class="fw-normal mb-5" style="color: #4835d4;">General
                                                                Infomation</h3>
                                                            <div class="row">
                                                                <div class="col-md-6 mb-4 pb-2">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="form3Examplev2"
                                                                            ...
                                                                            name="hname" :value="old('hname')" />
                                                                        <label class="form-label"
                                                                            for="form3Examplev2">Full Hospital
                                                                            Name</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 pb-2">
                                                                <div class="form-outline">
                                                                    ...
                                                                    <label class="form-label"
                                                                        for="form3Examplev4">Regd. No.</label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-4 pb-2">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="form3Examplev2"
                                                                            class="form-control form-control-lg"
                                                                            value="{{ $hospital->trade }}"
                                                                            name="trade" required />
                                                                        <label class="form-label"
                                                                            for="form3Examplev2">Trade Licence
                                                                            No.</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 pb-2">
                                                                <div class="form-outline">
                                                                    ...
                                                                    <label class="form-label"
                                                                        for="form3Examplev4">Owner's Name</label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7 mb-4 pb-2">
                                                                    <div class="form-outline form-white">
                                                                        <input type="number" id="form3Examplea4"
                                                                            ...
                                                                            name="phone" required />
                                                                        <label class="form-label"
                                                                            for="form3Examplea4">Phone Number</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-7 mb-4 pb-2">
                                                                            ...
                                                                            <div class="col-sm-10 input-column">
                                                                                <select class="form-control selcls"
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        ...
                                                                                        <option value="Bidhannagar">
                                                                                            Bidhannagar</option>
                                                                                        <option value="Howrah">Howrah
                                                                                        </option>
                                                                                        <option value="Serampore">
                                                                                            Serampore</option>
                                                                                        <option value="Bhadrhwar">
                                                                                            Bhradeswar</option>
                                                                                        <option value="Chandannagar">
                                                                                            Chandannagar</option>
                                                                                        <option value="Chinsurah">
                                                                                            Chinsurah</option>
                                                                                        <option value="Bandel">Bandel
                                                                                        </option>
                                                                                        <option value="Uttarpara">
                                                                                            Uttarpara</option>
                                                                                        <option value="Salar">Salar
                                                                                        </option>
                                                                                        <option value="Salua">Salua
                                                                                        </option>
                                                                                        <option value="Purulia">Purulia
                                                                                        </option>
                                                                                        <option value="Bashirhat">
                                                                                            Bashirhat</option>
                                                                                        <option value="Hashnabad">
                                                                                            Hashnabad</option>
                                                                                        <option value="Taki">Taki
                                                                                        </option>
                                                                                        <option value="Barrackpore">
                                                                                            Barrackpore</option>
                                                                                        <option value="Katwa">Katwa
                                                                                        </option>
                                                                        ...
                                                                        <div class="form-outline form-white">
                                                                            <label class="form-label"
                                                                                for="form3Examplea8">Available
                                                                                Facilities</label>
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="I.C.U."
                                                                                {{ in_array('I.C.U.', $hospital->requirements) ? 'checked' : '' }} />I.C.U.
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="VENTILATION"
                                                                                {{ in_array('VENTILATION', $hospital->requirements) ? 'checked' : '' }} />VENTILATION
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="COVID BED"
                                                                                {{ in_array('COVID BED', $hospital->requirements) ? 'checked' : '' }} />COVID
                                                                            BED
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="NORMAL BED"
                                                                                {{ in_array('NORMAL BED', $hospital->requirements) ? 'checked' : '' }} />NORMAL
                                                                            BED
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="COVID VACCINATION"
                                                                                {{ in_array('COVID VACCINATION', $hospital->requirements) ? 'checked' : '' }} />COVID
                                                                            VACCINATION
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="CITY SCAN"
                                                                                {{ in_array('CITY SCAN', $hospital->requirements) ? 'checked' : '' }} />CITY
                                                                            SCAN
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="BLOOD BANK"
                                                                                {{ in_array('BLOOD BANK', $hospital->requirements) ? 'checked' : '' }} />BLOOD
                                                                            BANK
                                                                            <input type="checkbox" name="requirements[]"
                                                                                value="OXYGEN AVALABILITY"
                                                                                {{ in_array('OXYGEN AVALABILITY', $hospital->requirements) ? 'checked' : '' }} />OXYGEN
                                                                            AVALABILITY
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="adjust">
                                                                        <label
                                                                            class="form-check-label checkbox text-black"
                                                                            for="formCheck-1">
                                                                            I do accept the <a href="/terms&conditions"
                                                                                class="text-black"><u>Terms and
