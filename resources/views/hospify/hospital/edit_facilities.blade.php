...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="inner">
            <form action="{{ route('Facilities.update', $id) }}" method="POST">
                {{ csrf_field() }}
                <h3>Update Facilities</h3>
                <input type="hidden" name="_method" value="PATCH" />
                <div class="form-wrapper form-price">
                    <label for="" class="label-input">I.C.U. available?(yes/no)</label>
                    <input type="text" name="icu" value="{{ $student->ICU }}" class="form-control">
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">Ventilation available?(yes/no)</label>
                    <input type="text" name="ventilation" value="{{ $student->VENTILATION }}" class="form-control">
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">Covid Vaccination available?(yes/no)</label>
                    <input type="text" name="covid" value="{{ $student->COVID_VACCINATION }}" class="form-control">
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">Blood Bank available?(yes/no)</label>
                    <input type="text" name="bloodbank" value="{{ $student->BLOOD_BANK }}" class="form-control">
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">City Scan available?(yes/no)</label>
                    <input type="text" name="cityscan" value="{{ $student->CITY_SCAN }}"
                        class="form-control"></input>
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">Oxygen available?(yes/no)</label>
                    <input type="text" name="oxygen" value="{{ $student->OXYGEN_AVALABILITY }}"
                        class="form-control"></input>
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">No. of Normal Bed</label>
                    <input type="number" name="normalbed" value="{{ $student->NORMAL_BED }}"
                        class="form-control"></input>
                </div>
                <div class="form-wrapper">
                    <label for="" class="label-input">No. of Covid Bed</label>
                    <input type="number" name="covidbed" value="{{ $student->COVID_BED }}"
                        class="form-control"></input>
                </div>
