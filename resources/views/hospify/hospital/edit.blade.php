    ...
    <section id="banner" class="banner">
        <div class="bg-color">
            ...
            @foreach ($data as $student)
                <form method="post" action="/hospital_update">
                    {{ csrf_field() }}
                                                    ...
                                                    <div class="p-5">
                                                            ...
                                                            <div class="col-md-6 mb-4 pb-2">
                                                                <div class="form-outline">
                                                                    <input type="text" id="form3Examplev2"
                                                                        ...
                                                                        value="{{ $student->hname }}" name="hname"
                                                                        required />
                                                                    <label class="form-label"
                                                                        for="form3Examplev2">Full
                                                                        Hospital Name</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-4 pb-2">
                                                                <div class="form-outline">
                                                                    <input type="text" id="form3Examplev2"
                                                                        class="form-control form-control-lg"
                                                                        value="{{ $student->trade }}" name="trade"
                                                                        required />
                                                                    <label class="form-label"
                                                                        for="form3Examplev2">Trade
                                                                        Licence No.</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-4 pb-2">
                                                            <div class="form-outline">
                                                                <input type="text" id="form3Examplev4"
                                                                    class="form-control form-control-lg"
                                                                    value="{{ $student->ownername }}" name="ownername"
                                                                    required />
                                                                <label class="form-label"
                                                                    for="form3Examplev4">Owner's
                                                                    Name</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="requirements">
                                                                <div class="checkbox1">
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="ICU"
                                                                        {{ in_array('ICU', $student->requirements) ? 'checked' : '' }} />I.C.U.
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="COVID_BED"
                                                                        {{ in_array('COVID_BED', $student->requirements) ? 'checked' : '' }} />COVID
                                                                    BED
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="VENTILATION"
                                                                        {{ in_array('VENTILATION', $student->requirements) ? 'checked' : '' }} />VENTILATION
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="NORMAL_BED"
                                                                        {{ in_array('NORMAL_BED', $student->requirements) ? 'checked' : '' }} />NORMAL
                                                                    BED
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="COVID_VACCINATION"
                                                                        {{ in_array('COVID_VACCINATION', $student->requirements) ? 'checked' : '' }} />COVID
                                                                    VACCINATION
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="CITY_SCAN"
                                                                        {{ in_array('CITY_SCAN', $student->requirements) ? 'checked' : '' }} />CITY
                                                                    SCAN
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="BLOOD_BANK"
                                                                        {{ in_array('BLOOD_BANK', $student->requirements) ? 'checked' : '' }} />BLOOD
                                                                    BANK
                                                                    <input type="checkbox" name="requirements[]"
                                                                        value="OXYGEN_AVALABILITY"
                                                                        {{ in_array('OXYGEN_AVALABILITY', $student->requirements) ? 'checked' : '' }} />OXYGEN
                                                                    AVALABILITY
                                                                </div>
                                                                <label class="form-label"
                                                            ...
                                                            <div
                                                                ...
                                                                <input class="form-check-input me-3" type="checkbox"
                                                                    ...
                                                                    onclick="change_button(this,'button')" />
                                                                <div class="adjust">
                                                            ...
                                                            <button type="submit" class="btn btn-primary pulse"
                                                                data-mdb-ripple-color="dark" value="submit" id="button"
